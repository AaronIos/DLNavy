...
- (void) initialize {
    ...
    // Add the cloud background color by GL 2017 / 2 / 8
    //增加手势
...
- (void) createTableView {
    ...
    if (@available(iOS 11.0, *)) {
        // add by GL 解决iOS11 预估行高问题
        _uiTableView.estimatedRowHeight = 0;
        _uiTableView.estimatedSectionHeaderHeight = 0;
        _uiTableView.estimatedSectionFooterHeight = 0;
    }
