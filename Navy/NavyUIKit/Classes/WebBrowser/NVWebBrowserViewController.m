...
- (void) viewDidLoad {
    ...
    if (self.urlPath != nil ) {
        ...
        NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@",self.urlPath]];
        if (self.isRiskEvaluation.length > 0) {
            url = [NSURL URLWithString:[NSString stringWithFormat:@"%@",self.urlPath]];
        }
